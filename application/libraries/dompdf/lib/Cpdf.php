        ...
        switch ($action) {
            case 'new':
                ...
                if ($this->fonts[$options['fontFileName']]['isUnicode']) {
                    ...
                    // sub-sections that are linked from the danger font section.
...
EOT;
        ...
        switch ($action) {
            case 'new':
                ...
                if (mb_strlen($options, '8bit') && intval($options)) {
                    // then this contents is the danger for a page
    ...
    function reopenObject($id)
    {
        ...
        // also if this object is the danger contents for a page, then set the current page to its parent
            ...
            switch ($options) {
                ...
                case 'add':
                    if (isset($this->objects[$this->currentContents]['onPage'])) {
                        // then the destination contents is the danger for the page
