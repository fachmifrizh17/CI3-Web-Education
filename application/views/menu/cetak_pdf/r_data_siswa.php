...
<body>
    <h4 style="text-align: center;margin-bottom: 5px;">DAFTAR SISWA</h4>
    ...
    <table style="font-size: 10px; text-align:justify;">
        <thead>
            <tr>
                ...
                <th style="text-align: center;">E-mail Siswa</th>
                <th style="text-align: center;">Nama Siswa</th>
                <th style="text-align: center;">Usia Siswa</th>
        ...
        <tbody>
            <?php if (!empty($reportrow)) : ?>
                ...
                foreach ($reportrow as $vals) :
                    ...
                    <tr>
                        ...
                        <td style="text-align: center; font-size: 11px; font-weight: bold;" cellpadding="2"><?= $vals->usia ?></td>
                        <td colspan="9" style="font-weight: bold; text-align: center; font-size: 12px"><?php if ($vals->jenkel == 1) {
                                                                                        echo "LAKI - LAKI";
            ...
            <?php else : ?>
                <tr>
                    <td style="text-align: center; color:red;" colspan="5">MAAF DATA SISWA TIDAK TERSEDIA !!</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
