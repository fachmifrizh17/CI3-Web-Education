...
class Kelas extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->model('master_data/Kelas_model');
    ...
    public function get_data()
    {
        ...
        if ($nama) {
            $kelas = $this->Kelas_model->get_kelas_by_kode($nama);
    ...
    public function tambah()
    {
		...
		$CekKode = $this->Kelas_model->CekKode($kode);
        $data_siswa = $this->Kelas_model->get_kelas_by_kode($kode);

        if (empty($CekKode)) {
            $this->db->trans_start();
            $this->db->trans_strict(FALSE);
            $ambilnomor = "KLS". $data_siswa;
			$get["kode"] = $this->Kelas_model->GetMaxNomor($ambilnomor);
			if (!$get["kode"]) {
				$kode = "000001";
			} else {
            ...
            $this->db->insert('glbm_kelas', $data);
    ...
    public function update()
    {
        ...
        $nama = $this->input->post("nama");
        $data_user = $this->Kelas_model->get_kelas_by_kode($nama);
        ...
        if ($data_user != null) {
            ...
            $this->db->update('glbm_kelas', $data, ["nama" => $nama]);
    ...
    public function status()
    {
        ...
        $nama = $this->input->post("nama");
        $data_kelas = $this->Kelas_model->get_kelas_by_kode($nama);
